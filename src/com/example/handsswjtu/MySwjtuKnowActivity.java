...
public class MySwjtuKnowActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_my_swjtu_know);
		...
		loadData(pageNo);
		swjtuKnowContentAdapter = new DifferentColorListViewAdapter(MySwjtuKnowActivity.this, swjtuKnowEntitiesMapList,
				R.layout.listview_swjtu_know_list, new String[] { "replyNum", "title", "questionFrom", "ctime",
						"isSolved" }, new int[] { R.id.replyNum, R.id.questionTitle, R.id.questionFrom, R.id.ctime,
						R.id.isSolved });
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				...
				if (scrollState == OnScrollListener.SCROLL_STATE_IDLE
					...
					if (!NO_MORE_DATA) {
						...
						Toast.makeText(MySwjtuKnowActivity.this, "没有更多数据了哦", Toast.LENGTH_SHORT).show();
					}
				}
			}
	...
	OnItemClickListener onItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			// TODO Auto-generated method stub
			Intent it = new Intent(MySwjtuKnowActivity.this, MySwjtuKnowDetailActivity.class);
	...
	OnClickListener onClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.addSwjtuKnowQuestion:
				...
				Intent it = new Intent(MySwjtuKnowActivity.this, AddQuestionActivity.class);
				startActivity(it);
				// }else{
	...
	public void loadData(final int pageNo) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				// TODO Auto-generated method stub
				if (DataProvider.swjtuKnowListMapListProvider(swjtuKnowEntitiesMapList, pageNo,
						(new SharePreferenceHelper()).getStuCode())) {
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				break;
			case 2:
				Toast.makeText(MySwjtuKnowActivity.this, "现在没有数据哦", Toast.LENGTH_SHORT).show();
				loadingProgressBar.setVisibility(View.INVISIBLE);
				break;
			case 3:
				Toast.makeText(MySwjtuKnowActivity.this, "联网失败，请重试", Toast.LENGTH_SHORT).show();
				break;
			default:
				break;
			}
			...
			public void run() {
				...
				if (DataProvider.swjtuKnowListMapListProvider(swjtuKnowEntitiesMapList, pageNo,
					...
					if (swjtuKnowEntitiesMapList.size() != 0) {
						...
						int a=swjtuKnowEntitiesMapList.size();
						if (swjtuKnowEntitiesMapList.size() % 10 != 0) {
							NO_MORE_DATA = true;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			swjtuKnowEntitiesMapList.clear();
			pageNo=1;
			loadData(pageNo);
